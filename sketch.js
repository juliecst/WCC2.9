// I adapted the code from the lab by moving the grid to the other side and making it like a short echo of an increasingly blurring image.
...
function draw() {
    background(20,40, 30);
    //this makes a trippy echo in the image
    blendMode(LIGHTEST);
    image(video, 0, 0);
    ...
    //do not remove the line below! otherwise you get an efficiancy issue
        ...
        for (let x = 0; x < currImg.width; x += 1) {
            for (let y = 0; y < currImg.height; y += 1) {
                ...
                if (d > threshold) {
                    ...
                    diffImg.pixels[index + 2] = 25;
                    diffImg.pixels[index + 3] = 25;
                }
            }
        }
    }
